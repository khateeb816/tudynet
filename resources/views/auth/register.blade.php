...
@section('title', 'Register - Studynet')
    ...
    <div class="row g-0 auth-wrapper">
        ...
        <div class="col-lg-5 auth-right d-flex align-items-center justify-content-center p-5">
            <div class="w-100" style="max-width: 450px;">
                ...
                <p class="text-muted mb-5 small">Join Studynet Management System today.</p>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <button type="submit" class="btn btn-studynet mb-4">Register</button>
